...
function getMySimpleProfile() {
    ...
    $.ajax(settings).done(function (response, status) {
        ...
        $('#myProfileImage2').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage3').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage4').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage5').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage6').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage7').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
        $('#myProfileImage8').attr('src', response['profileImage'] == null ? '../static/images/nullprofile.jpeg' : response['profileImage'])
...
function showUpdateButton(userId, postId) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + postId,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function showFollowButton(userId, postId) {
    $.ajax({
        url: "https://api.odle8.com/users/" + userId + "/follow-or-unfollow",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function followUser(userId) {
    var settings = {
        "url": "https://api.odle8.com/users/" + userId + "/follow",
        "method": "POST",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function unfollowUser(userId) {
    var settings = {
        "url": "https://api.odle8.com/users/" + userId + "/unfollow",
        "method": "DELETE",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function showFeedLikeButton(postId) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + postId + "/like-or-unlike",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function likePost(postId) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + postId + "/like",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function unlikePost(postId) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + postId + "/unlike",
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
