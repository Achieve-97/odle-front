...
const api_url = "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/users/"; //공통 Url
...
function followUser(followUserId) {
    $.ajax({
        url: "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/users/" + followUserId + "/follow",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function unfollowUser(UnfollowUserId) {
    $.ajax({
        url: "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/users/" + UnfollowUserId + "/unfollow",
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
