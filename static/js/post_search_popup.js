...
function get_post(post_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id,
        type: "GET",
        dataType: "json",
        success: function (response) {
            ...
            <div class="post_info_container">
                ...
                <p id="my_profileImage" style="cursor : pointer">
...
function showPostLikeButton(post_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/like-or-unlike",
        type: "GET",
        dataType: "json",
        headers: {
...
function like_post(post_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/like",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function unlike_post(post_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/unlike",
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function showCommentLikeButton(post_id, comment_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/comments/" + comment_id + "/like-or-unlike",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function like_comment(post_id, comment_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/comments/" + comment_id + "/like",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function unlike_comment(post_id, comment_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/comments/" + comment_id + "/unlike",
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
...
function delete_comment(post_id, comment_id) {
    $.ajax({
        url: "https://api.odle8.com/posts/" + post_id + "/comments/" + comment_id,
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": localStorage.getItem("accessToken")
