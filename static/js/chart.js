...
function getAngryChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/angry",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getSadChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/sad",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getScreamChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/scream",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getShyChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/shy",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getHappyChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/happy",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getLoveChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/love",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
...
function getFlexChart() {
    var settings = {
        "url": "http://ec2-3-37-153-26.ap-northeast-2.compute.amazonaws.com/music/charts/flex",
        "method": "GET",
        "timeout": 0,
        "headers": {
            "Authorization": localStorage.getItem('accessToken')
